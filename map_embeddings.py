...
def main():
    ...
    recommended_type.add_argument('--mikolov2013', metavar='DICTIONARY', help='reproduce our Mikolov 2013 system')
    ...
    if args.mikolov2013:
        parser.set_defaults(init_dictionary=args.mikolov2013, unconstrained=True, normalize=[], batch_size=1000)
    args = parser.parse_args()
    ...
    src_words, x = embeddings.read_new(srcfile, 200000, dtype=dtype)
    trg_words, z = embeddings.read_new(trgfile, 200000, dtype=dtype)
